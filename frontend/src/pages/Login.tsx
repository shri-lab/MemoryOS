...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // 5. Navigate to default landing page preference
            ...
            <div className="w-full lg:w-[55%] flex items-center justify-center p-6 lg:p-12 bg-obsidian/40 relative overflow-hidden">
                ...
                <div className="w-full max-w-[400px] glass-panel p-8 rounded-2xl shadow-cyan-glow relative z-10">
                        ...
                        <div className="flex items-center justify-between pt-1">
                            <label className="flex items-center space-x-2 text-xs text-muted cursor-pointer select-none">
                                <input
                                    ...
                                    className="rounded border-glass-border text-primary focus:ring-primary/30 bg-obsidian/60"
                                lock-aria="remember-checkbox"/>
                            ...
                            <div className="relative group inline-block">
                                <button
                                    type="button"
                                    disabled
                                    className="text-xs text-muted/40 cursor-not-allowed font-medium hover:underline"
                                >
                                    Forgot password?
                                </button>
                                <span className="absolute bottom-full right-0 mb-1.5 w-24 bg-obsidian border border-glass-border text-secondary text-[9px] text-center py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-150 pointer-events-none font-mono tracking-wider">
                                    COMING SOON
                                </span>
                            </div>
                        </div>

                        {/* Primary login button: Rebuilt to pill-shaped outline with mint glow */}
                        <button
                            type="submit"
                            disabled={loading || success}
                    ...
                    <div className="mt-8 text-center text-xs text-muted">
                        ...
                        <Link to="/register" className="text-secondary hover:text-secondary/85 font-semibold transition duration-150 hover:underline">
                            Sign Up
                        </Link>
                    </div>
                </div>
